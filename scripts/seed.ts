  ...
  try {
    ...
    const services = await Service.insertMany([
      {
        ...
        descriptionAr: 'خدمات قص الخرسانة الدقيقة لمشاريع البناء والتجديد. المعدات الاحترافية والفنيون الخبراء يضمنون قصًا نظيفًا ودقيقًا في كل مرة.',
        icon: 'concrete-cutting',
        features: ['Diamond blade cutting', 'Precision accuracy', 'Minimal dust', '24-hour service'],
        featuresAr: ['قص بشفرة الماس', 'دقة عالية', 'غبار قليل', 'خدمة على مدار 24 ساعة'],
        featured: true,
      },
      {
        title: 'Reinforced Concrete Cutting',
        titleAr: 'قص الخرسانة المسلحة',
        ...
        descriptionAr: 'خدمات قص متخصصة للهياكل الخرسانية المسلحة. حلول آمنة وفعالة للمشاريع المعقدة التي تتطلب السلامة الهيكلية.',
    ...
    const projects = await Project.insertMany([
      ...
      },
      {
        ...
        titleAr: 'إصلاح وقص سطح الجسر',
        description: 'Specialized cutting and repair work on bridge deck structures with minimal disruption.',
        descriptionAr: 'عمل قص وإصلاح متخصص على هياكل سطح الجسر مع الحد الأدنى من الاضطراب.',
        image: '/cutting-concrete-service.webp',
        tags: ['Cutting', 'Infrastructure', 'Repair'],
        tagsAr: ['قص', 'بنية تحتية', 'إصلاح'],
        category: 'Cutting',
        categoryAr: 'قص',
        year: '2023',
        featured: false,
    ...
    const testimonials = await Testimonial.insertMany([
      ...
      },
      {
        ...
        textAr: 'أفضل فريق عملت معه في قص الخرسانة. التزموا بالسلامة والمواعيد النهائية 100%. خدمة احترافية وموثوقة للغاية.',
        approved: true,
      },
      {
